...
msb = 'rm -rf tmp/milestone && milestoner build --format html && open tmp/milestone/index.html'
...
....
pgi = PostgreSQL Initialize - Initialize PostgreSQL database.
