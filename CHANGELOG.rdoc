...
* Added Bond[https://github.com/cldwalker/bond] gem support to .irbrc and .pryrc.
...
* Removed the tree alias, using the Tree app instead. See the OSX[https://github.com/bkuhlmann/osx] for details.
* Added Z[https://github.com/rupa/z] support for Bash.
