...
manual care regardless of whether you tweaked the files prior to installation or not:
...
Please log all feedback/issues via {GitHub Issues}[https://github.com/bkuhlmann/dotfiles/issues]. Thanks.
