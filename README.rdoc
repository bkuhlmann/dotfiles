...
* Configures the {Ruby on Rails}[http://rubyonrails.org] .railsrc file (includes {Rails Setup Template}[https://github.com/bkuhlmann/rails_setup_template] support).
...
* {Ruby on Rails 3.2.x+}[http://rubyonrails.org] - Necessary for .railsrc file enhancements.
