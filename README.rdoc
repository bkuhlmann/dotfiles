...
A Ruby script for easily configuring your Mac OS user profile settings. By default, these are set to my preferences but you can easily
...
Current Version (stable)
  ...
  git clone git://github.com/bkuhlmann/macos_setup.git
  git checkout v1.2.0
  cd macos_setup
...
You can delete the macos_setup directory after completing installation.
