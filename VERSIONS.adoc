...
* ✅ Fixed Bash make flags configuration - Brooke Kuhlmann
* 🟢 Added Atuin Bash setup - Brooke Kuhlmann
* 🟢 Added Ruby web server function path parameter - Brooke Kuhlmann
* 🔼 Updated Milestoner functions to handle multiple versions - Brooke Kuhlmann
* 🔼 Updated to Caliber 0.68.0 - Brooke Kuhlmann
* 🔼 Updated to Git Lint 9.0.0 - Brooke Kuhlmann
* 🔼 Updated to Ruby 3.4.0 - Brooke Kuhlmann
* ⛔️ Removed subject from Git tag log output - Brooke Kuhlmann
* 🔁 Refactored Bash configuration - Brooke Kuhlmann

== 54.7.0 (2024-11-09)

* ✅ Fixed ASCII Doc function to use default browser - Brooke Kuhlmann
* 🟢 Added speed alias for checking network quality - Brooke Kuhlmann
* 🔼 Updated Ruby web server function to open site after launch - Brooke Kuhlmann
* 🔼 Updated to Caliber 0.64.0 - Brooke Kuhlmann
* 🔼 Updated to Git Lint 8.7.0 - Brooke Kuhlmann

== 54.6.1 (2024-11-05)

* ✅ Fixed Bash ICU4C package config path for pgenv - Brooke Kuhlmann
* ✅ Fixed Git guise functions to print info - Brooke Kuhlmann
* 🔼 Updated to Ruby 3.3.6 - Brooke Kuhlmann

== 54.6.0 (2024-10-19)

* 🟢 Added Duti MKV video format - Brooke Kuhlmann
* 🟢 Added Git log line enrichment - Brooke Kuhlmann
* 🟢 Added Git tag last function - Brooke Kuhlmann
* 🔼 Updated Git commits since last tag to use last tag function - Brooke Kuhlmann
* 🔼 Updated Git log functions to use enriched formatting - Brooke Kuhlmann
* 🔁 Refactored Git tag last info function name - Brooke Kuhlmann

== 54.5.0 (2024-10-14)

* 🟢 Added Git SHA function - Brooke Kuhlmann
* 🟢 Added Git branch parent function - Brooke Kuhlmann
* 🟢 Added Git branch range function - Brooke Kuhlmann
* 🟢 Added NPM authentication alias - Brooke Kuhlmann
* 🔼 Updated Git tag list alias as a function - Brooke Kuhlmann
* ⛔️ Removed Git commit last and branch sha functions - Brooke Kuhlmann
* 🔁 Refactored Git aliases/functions to use parent branch and SHA functions - Brooke Kuhlmann
* 🔁 Refactored GitHub pull request and branch list functions - Brooke Kuhlmann

== 54.4.2 (2024-09-15)

* ✅ Fixed Milestoner functions to account for non-repositories - Brooke Kuhlmann
* 🔁 Refactored attributes to global Git configuration root - Brooke Kuhlmann
...
🟢 Added Git GPG allowed signers configuration - Brooke Kuhlmann
🟢 Added Git branch view alias - Brooke Kuhlmann
🟢 Added README Developer Certificate of Origin documentation - Brooke Kuhlmann
🔁 Refactored Git log interactive function to align options - Brooke Kuhlmann

== 54.3.0 (2024-08-03)

* ✅ Fixed Git show details private function to include patch details - Brooke Kuhlmann
* 🟢 Added Git guise add and delete functions - Brooke Kuhlmann
* 🟢 Added Git log fuzzy find function - Brooke Kuhlmann
* 🔼 Updated Git commit fixup function to use fuzzy find - Brooke Kuhlmann
* 🔼 Updated Git diff files function to be interactive - Brooke Kuhlmann
* 🔼 Updated Git log grep as function with fuzzy find - Brooke Kuhlmann
* 🔼 Updated Git log interactive function to use fuzzy find - Brooke Kuhlmann
* 🔼 Updated Git log search as function with fuzzy find - Brooke Kuhlmann
* 🔼 Updated Git stash to show untracked files - Brooke Kuhlmann
* ⛔️ Removed Git maintenance setup on repository initialization - Brooke Kuhlmann
* 🔁 Refactored Git config usage - Brooke Kuhlmann

== 54.2.0 (2024-07-25)

* 🟢 Added XDG bin path - Brooke Kuhlmann
* 🟢 Added pgsql saved queries - Brooke Kuhlmann
* 🟢 Added retest alias - Brooke Kuhlmann
* 🔼 Updated du alias to use Dust - Brooke Kuhlmann

== 54.1.0 (2024-07-20)

* ✅ Fixed Git Hook typo with JavaScript alert statements - Brooke Kuhlmann
* 🔼 Updated to Ruby 3.3.4 - Brooke Kuhlmann
* 🔼 Updated to using Eza instead of Exa - Brooke Kuhlmann

== 54.0.0 (2024-07-07)

* 🟢 Added Git attributes diffing for Rails credentials - Brooke Kuhlmann
* 🟢 Added Git checkout alias - Brooke Kuhlmann
* 🔼 Updated IRB configuration to register IRB Kit commands - Brooke Kuhlmann
* 🔼 Updated Milestoner aliases as functions - Brooke Kuhlmann
...
* ✅ Fixed Ruby version template to reflect current version - Brooke Kuhlmann
* 🟢 Added Git Ruby URL configuration - Brooke Kuhlmann
* 🟢 Added Ruby debug frozen string literal option - Brooke Kuhlmann
* 🔼 Updated Milestoner alias to specify build maximum - Brooke Kuhlmann
* 🔼 Updated citation URLs - Brooke Kuhlmann
* 🔼 Updated to Ruby 3.3.2 - Brooke Kuhlmann

== 53.3.0 (2024-05-21)

* ✅ Fixed Git template signed off by key typo - Brooke Kuhlmann
* ✅ Fixed IRB configuration load errors - Brooke Kuhlmann
* 🔼 Updated IRB configuration to use IRB Kit - Brooke Kuhlmann

== 53.2.0 (2024-05-02)

* 🟢 Added Git configuration for source and destination diff prefixes - Brooke Kuhlmann
* 🟢 Added Homebrew reinstall alias - Brooke Kuhlmann
* 🟢 Added Milestoner build alias for syndicated feeds - Brooke Kuhlmann
* 🟢 Added pgenv setup script - Brooke Kuhlmann

== 53.1.0 (2024-04-23)

* 🟢 Added JavaScript update all function - Brooke Kuhlmann
* 🟢 Added pgenv package config path for icu4c - Brooke Kuhlmann
...
* ✅ Fixed Git Hook for RSpec dotfile error - Brooke Kuhlmann
* 🔼 Updated Git configuration to use Difftastic - Brooke Kuhlmann
* 🔼 Updated PostgreSQL aliases and functions to use pgenv - Brooke Kuhlmann
* 🔼 Updated RuboCop run all function to account for XDG path - Brooke Kuhlmann
* 🔼 Updated gem dependencies function to use ripgrep - Brooke Kuhlmann
* ⛔️ Removed Git Hook extension for Capybara - Brooke Kuhlmann
* ⛔️ Removed Git hooks for RSpec focus - Brooke Kuhlmann
* 🔁 Refactored Git hook extension for adding trailers to use sd - Brooke Kuhlmann
...
* 🟢 Added Bash configuration for pgenv - Brooke Kuhlmann
* 🟢 Added Git configuration for verbose commits - Brooke Kuhlmann
* 🟢 Added Git import function - Brooke Kuhlmann
* 🟢 Added PostgreSQL vet configuration - Brooke Kuhlmann

== 52.3.0 (2024-02-18)

* ✅ Fixed Brakeman Git hook extension to be quiet and exit on error - Brooke Kuhlmann
* ✅ Fixed Git hook escaping of trailer new lines - Brooke Kuhlmann
* 🟢 Added OrbStack initialization - Brooke Kuhlmann
* 🔁 Refactored Bash configuration conditionals - Brooke Kuhlmann

== 52.2.0 (2024-02-10)

* ✅ Fixed Git blame alias and function - Brooke Kuhlmann
* 🟢 Added IRB configuration for Amazing Print - Brooke Kuhlmann
* 🔼 Updated Brakeman output to only print if issues are detected - Brooke Kuhlmann
* 🔁 Refactored Git hook extension to use interpret trailers - Brooke Kuhlmann
* 🔁 Refactored function parameters to use colons instead of dashes - Brooke Kuhlmann

== 52.1.0 (2024-01-28)

* ✅ Fixed Milestoner build aliases - Brooke Kuhlmann
* 🟢 Added Milestoner ASCII doc and Markdown build aliases - Brooke Kuhlmann
* 🟢 Added dynamic trailers for Git prepare commit message hook - Brooke Kuhlmann
* 🔼 Updated to Caliber 0.50.0 - Brooke Kuhlmann

== 52.0.0 (2024-01-01)

* Fixed Bundler configuration path - Brooke Kuhlmann
* Fixed Kernel deprecation warnings with open method - Brooke Kuhlmann
* Updated Bash configuration to include Ruby performance warnings - Brooke Kuhlmann
* Updated Circle CI step names - Brooke Kuhlmann
* Updated gem dependencies - Brooke Kuhlmann
* Updated to Ruby 3.3.0 - Brooke Kuhlmann
* Removed Ruby Debugger documentation - Brooke Kuhlmann

== 51.0.0 (2023-11-26)

* Added IRB aliases - Brooke Kuhlmann
* Added NPM aliases - Brooke Kuhlmann
* Added Rakefile quality task - Brooke Kuhlmann
* Added XDG config and cache home directories - Brooke Kuhlmann
* Updated Docker compose run alias to auto-remove containers - Brooke Kuhlmann
* Updated IRB to use Reline face and type completion configurations - Brooke Kuhlmann
* Updated NPM global configuration - Brooke Kuhlmann
* Updated Overmind start function to accept optional environment - Brooke Kuhlmann
* Updated root configurations to use XDG config folder - Brooke Kuhlmann
* Removed Rakefile code prefix from quality task - Brooke Kuhlmann
* Removed Ruby Debug home confguration - Brooke Kuhlmann

== 50.1.0 (2023-10-22)

* Fixed Milestoner build alias to always delete temp dirctory - Brooke Kuhlmann
* Added Duti configuration for associating IINA with WebM formats - Brooke Kuhlmann
* Added Git global profile management alias - Brooke Kuhlmann
* Added JavaScript Force function - Brooke Kuhlmann
